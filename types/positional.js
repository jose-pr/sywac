...
class TypePositional extends wrapper_1.default {
    ...
    configure(opts, override) {
        ...
        if (override || typeof this.acceptFlags === 'undefined')
            this.acceptFlags = 'acceptFlags' in opts ? opts.acceptFlags : this.acceptFlags;
        if (override || typeof this._variadic === 'undefined')
            this._variadic = 'variadic' in opts ? opts.variadic : this._variadic;
        return this;
    }
    get isVariadic() {
    ...
    validateConfig(utils) {
        if (this.acceptFlags)
            this.elementType.validateConfig(utils);
    }
    // called by api
    async parse(context) {
...
exports.TypePositional = TypePositional;
exports.default = TypePositional;
